...
class App extends Component {
  ...
  handleKeyDown = (e) => {
    const { randomAlpha, correctCount, incorrectCount, remainingTime } = this.state;
    ...
    if (remainingTime > 0) {
      ...
      this.setState({ enteredKey: enteredKeyLowerCase });
      this.generateRandomAlpha();
    }
  };
    ...
    return (
      <div className="app-container">
        ...
        <div className="entered-text">
          <span className='stat-label'>Entered Text: </span>
          <span className = "stat-value">{enteredKey}</span>
          </div>
